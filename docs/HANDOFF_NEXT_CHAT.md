...
```powershell
cd E:\桌面\播放器软件\StarTune\resources\app
...
- 当前真实代码/Git 仓库：`E:\桌面\播放器软件\StarTune\resources\app`
- 当前版本：`v1.1.0`
...
- GitHub 仓库已公开：`https://github.com/StarTune/StarTune`
- `v1.1.0` Release：`https://github.com/StarTune/StarTune/releases/tag/v1.1.0`
...
- 没有本地 `startune-lyric-layout-v1` 时，`readSavedLyricLayout()` 使用 packaged 默认快照；没有本地用户存档 key 时自动创建「默认测试」槽位。
...
- 已生成安装包：`dist/StarTune-1.1.0-Setup.exe`。
- 已生成校验文件：`dist/StarTune-1.1.0-SHA256SUMS.txt`。
...
- Release 建议上传：
  - `dist/StarTune-1.1.0-Setup.exe`
  - `dist/StarTune-1.1.0-Setup.exe.blockmap`
  - `dist/StarTune-1.1.0-SHA256SUMS.txt`
